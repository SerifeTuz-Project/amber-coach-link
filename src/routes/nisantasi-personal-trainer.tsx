...
const WA_URL =
  "https://wa.me/905061511150?text=Merhaba%2C%20Nişantaşı'nda%20personal%20training%20hakkında%20bilgi%20almak%20istiyorum.";
...
const SCHEMA = JSON.stringify({
  ...
  description:
    "Nişantaşı'nda birebir ve online personal training hizmeti. Kilo verme, kas yapma ve form değişimi için uzman koçluk.",
  url: "https://erkanoduncu.com/nisantasi-personal-trainer",
  ...
  geo: { "@type": "GeoCoordinates", latitude: "41.0502", longitude: "28.9930" },
  priceRange: "₺₺₺",
  openingHours: "Mo-Sa 08:00-21:00",
  sameAs: ["https://instagram.com/erkanodnc"],
});

export const Route = createFileRoute("/nisantasi-personal-trainer")({
  head: () => ({
    meta: [
      { title: "Nişantaşı Personal Trainer | Erkan Oduncu — Kişisel Antrenör" },
      {
        name: "description",
        content:
          "Nişantaşı'nın en iyi personal trainer'ı Erkan Oduncu ile kilo ver, kas yap, form değiştir. Birebir yüz yüze antrenman ve online koçluk. Ücretsiz 30 dk deneme dersi.",
      },
      {
        name: "keywords",
        content:
          "Nişantaşı personal trainer, Nişantaşı kişisel antrenör, Nişantaşı PT, Nişantaşı fitness koçu, Nişantaşı kilo verme",
      },
      { property: "og:title", content: "Nişantaşı Personal Trainer | Erkan Oduncu" },
      {
        property: "og:description",
        content: "Nişantaşı'nda birebir personal training. Ücretsiz deneme dersi için hemen iletişime geç.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://erkanoduncu.com/nisantasi-personal-trainer" },
      { name: "geo.region", content: "TR-34" },
      { name: "geo.placename", content: "Nişantaşı, Şişli, İstanbul" },
      { name: "geo.position", content: "41.0502;28.9930" },
      { name: "ICBM", content: "41.0502, 28.9930" },
    ],
    links: [
      { rel: "canonical", href: "https://erkanoduncu.com/nisantasi-personal-trainer" },
    ],
    scripts: [{ type: "application/ld+json", children: SCHEMA }],
  }),
  component: NisantasiPT,
});

function NisantasiPT() {
  const faqs = [
    {
      q: "Nişantaşı'nda personal trainer hizmeti nasıl alınır?",
      a: "WhatsApp üzerinden iletişime geçin, ücretsiz 30 dakikalık tanışma seansı planlayalım. Nişantaşı ve çevresinde birebir antrenman seansları düzenliyorum.",
    },
    {
      q: "Nişantaşı personal trainer fiyatları ne kadar?",
    ...
    {
      q: "Nişantaşı'nda kilo vermek için ne yapmalıyım?",
      a: "Kilo vermek için antrenman + beslenme kombinasyonu şart. Erkan Oduncu ile kişisel program ve beslenme planınızı birlikte oluşturabilirsiniz.",
    },
  ];
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="px-5 md:px-8 pt-16 md:pt-24 pb-12 border-b border-border">
        <div className="mx-auto max-w-6xl">
          <div className="eyebrow text-gold mb-4">Nişantaşı · Personal Trainer</div>
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl uppercase leading-[0.9]">
            <span className="block text-white">Nişantaşı'nda</span>
            <span className="block text-gold">Personal Trainer</span>
          </h1>
          <p className="mt-6 max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed">
            Nişantaşı ve Teşvikiye'de birebir, kişiye özel antrenman programları.
            ...
            {[
              {
                ...
                desc: "Mahallenizde, size yakın bir lokasyonda birebir antrenman seansları.",
              },
              {
                icon: "🎯",
                title: "Kişiye Özel Program",
                desc: "Tek tip program yok. Hedefinize, vücut yapınıza ve yaşam tarzınıza göre tasarlanan program.",
              },
              {
                icon: "📱",
                title: "7/24 Destek",
                desc: "WhatsApp üzerinden sorularınızı anında yanıtlıyorum. Yalnız değilsiniz.",
              },
            ].map((f) => (
      ...
      >
        <div className="mx-auto max-w-3xl">
          <h2 className="font-display text-4xl md:text-6xl uppercase leading-[0.95]">
            <span className="text-white">Nişantaşı'nda</span>{" "}
      ...
      <footer className="border-t border-border px-5 md:px-8 py-8 text-center">
        <p className="text-xs text-muted-foreground">© 2025 Erkan Oduncu | Nişantaşı Personal Trainer</p>
      </footer>
    </main>
  );
}
