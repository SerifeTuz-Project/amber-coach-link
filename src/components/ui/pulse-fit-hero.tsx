...
export function PulseFitHero({
  ...
  return (
    ...
    >
      ...
      {/* Lamp ışık efekti — üst orta */}
      <div className="pointer-events-none absolute top-0 left-0 right-0 z-10 flex justify-center overflow-hidden" style={{ height: "280px" }}>
        <div className="relative flex w-full scale-y-125 items-start justify-center isolate">
          <motion.div
          ...
          <motion.div
            ...
            transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
            className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-slate-200 blur-2xl opacity-50"
          />
          <motion.div
            initial={{ width: "15rem" }}
